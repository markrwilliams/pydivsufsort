...
#endif
#include <math.h>
#define __PYX_HAVE___suffixarray
#define __PYX_HAVE_API___suffixarray
...
#define __Pyx_MODULE_NAME "_suffixarray"
int __pyx_module_is_main__suffixarray = 0;

/* Implementation of '_suffixarray' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_suffixarray(void); /*proto*/
PyMODINIT_FUNC init_suffixarray(void)
#else
PyMODINIT_FUNC PyInit__suffixarray(void); /*proto*/
PyMODINIT_FUNC PyInit__suffixarray(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__suffixarray(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_suffixarray"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "_suffixarray")) {
      if (unlikely(PyDict_SetItemString(modules, "_suffixarray", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  #endif
  if (__pyx_module_is_main__suffixarray) {
 ...
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__STUFF, ((PyObject *)__pyx_n_s__hi)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init _suffixarray", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _suffixarray");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
